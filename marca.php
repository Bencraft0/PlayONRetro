...
$conexion = mysqli_connect("sql302.byethost13.comster.comster.comster.comster.comster.comster.comster.comster.comster.com", "b13_36951409", "benjamin5");
      ...
      <div class="col-md-12">
        <div class="bootstrap-tabs product-tabs">
          <div class="tabs-header d-flex justify-content-between border-bottom my-5">
            <h3><?php echo $marca; ?> en venta</h3>
          </div>
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
              <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                <?php 
                $consulta1 = "SELECT * FROM productos WHERE marca = '$marca'";
                $productos = mysqli_query($conexion, $consulta1); 
