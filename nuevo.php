...
// 1) Conexion
$conexion = mysqli_connect("sql302.byethost13.comster.com", "b13_36951409", "benjamin5");
...
if (!$conexion) {
    ...
    if (isset($_POST['guardar_cambios'])) {
        ...
        $consulta = "INSERT INTO productos (id,nombre,descripcion,tipo,marca,imagen1,imagen2,precio,descuento,cant_vendidas,estrellas) 
        VALUES ('','$nombre','$descripcion','$tipo','$marca','$imagen1','$imagen2','$precio','$descuento','$cant_vendidas','$estrellas')";
