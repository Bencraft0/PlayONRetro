...
<body>
    ...
    $consulta = "SELECT * FROM carrito WHERE usuario_id = '$usuario_id' AND producto_id = '$producto_id'";
    $verificacion = mysqli_query($conexion, $consulta);

        if (mysqli_num_rows($verificacion) > 0) {
            $actualizar = "UPDATE carrito SET cantidad = cantidad + $cantidad WHERE usuario_id = '$usuario_id' AND producto_id = '$producto_id'";
            ...
            $agregar = "INSERT INTO carrito (usuario_id, producto_id, cantidad) VALUES ('$usuario_id', '$producto_id', '$cantidad')";
