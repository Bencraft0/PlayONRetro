...
<div class="preloader-wrapper">
      ...
      <p>Cargando...</p>
      <h2>Confie, en unos segundos cargara jeje</h2>
      <a href="inicio-instantaneo.php" class="btn btn-warning">Ver pagina ahora (puede que no hayan cargado algunos elementos aun)</a>
    </div>
...
<!-- NAVEGADOR -->
    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <h3 class='mb-3'>Para ver los productos que tienes en tu lista de favoritos debes iniciar sesión en tu cuenta de <strong>PlayONRetro.</strong></h3>
        <div class="text-muted mb-4">
            <br>
            <a class="btn btn-secondary" data-bs-dismiss="offcanvas" aria-label="Close">Volver a la página <strong>PRINCIPAL</strong>.</a>
            <a href="login_html.php" class="btn btn-success">Iniciar Sesión</a>
            <br><br>
            <label for="no-tener">¿No tienes una cuenta?</label>
            <a href="signup_html.php" class="btn btn-info"> Registrarse </a>
        </div>
    </div>
    <?php
} else {
    // Usuario ha iniciado sesión
    $conexion = mysqli_connect("sql302.byethost13.comster.comster.comster.comster.com", "b13_36951409", "benjamin5");
    mysqli_select_db($conexion, "b13_36951409_proyecto");
    ...
    $usuario_id = $_SESSION['id'];
    $consulta = "SELECT * FROM favoritos WHERE usuario_id = '$usuario_id'";
    ...
    if (mysqli_num_rows($resultados) <= 0) {
        ...
        <div class="container d-flex align-items-center justify-content-center min-vh-100">
            <div class="wishlist-container text-center">
                ...
                <h2 class="mb-3">¡Tu lista de deseos está vacía!</h2>
                <p class="text-muted mb-4">¡Agrega tus artículos favoritos para verlos aquí!</p>
            </div>
        </div>
        <?php
    } else {
        // Hay productos en la lista de favoritos
        ?>
          <section class="py-5">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="bootstrap-tabs product-tabs">
                          ...
                          while ($reg = mysqli_fetch_array($resultados)) {
                              ...
                              $productos = mysqli_query($conexion, $consulta_producto);
