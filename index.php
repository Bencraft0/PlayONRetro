              ...
              <div class="col-md-6 p-5">
                <form action="signup.php" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="pepito23@gmail.com.ar">
                  </div>
                  <div class="mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card-body p-0">
                    ...
                    <a href="ofertas.php" class="card-text">Click Aqui</a>
                  </div>
                </div>
              </div>
              </div>
